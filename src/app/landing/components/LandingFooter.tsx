      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mb-4">
              Revolutionizing event planning with agentic AI technology.
            </p>
                ...
                {[...Array(5)].map((_, j) => (
                  <li key={j}>
                    <a href="#" className="hover:text-white transition-colors">
                      {category === 'Product' ? 
                        ['Features', 'Agents', 'Pricing', 'Integration', 'Updates'][j] :
                        category === 'Company' ?
                        ['About', 'Team', 'Careers', 'Contact', 'Partners'][j] :
                        ['Blog', 'Guides', 'Support', 'API Docs', 'Community'][j]
                      }
                    </a>
                  </li>
                ))}
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">&copy; {new Date().getFullYear()} EventFlow.AI. All rights reserved.</p>
